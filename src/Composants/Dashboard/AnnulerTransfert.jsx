...
const AnnulerTransfer = () => {
  ...
  return (
    <div className='bg-white rounded-xl h-full p-5 flex flex-col items-center'>
      <h1 className='text-center text-2xl font-bold mb-4 text-bg-secondaire'>Demande d'annulation de transfert</h1>
      <p className="text-center text-gray-700 mb-6">
        Seul l'administrateur pourra valider ou refuser votre demande d'annulation.<br />
      ...
      {envoye ? (
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col gap-4">
          ...
          <div>
            <label className="block text-sm mb-1 text-gray-700">Motif de l'annulation</label>
            <textarea
              className="w-full border rounded px-3 py-2 text-sm"
              value={motif}
